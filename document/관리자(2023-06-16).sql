...
/*
oracle 12c 이상에서 사용자에 대한 권한정책이 변경 되었다.
...
/*
새로운 사용자를 생성하고 접속 비번 설정
이 사용자 정보를 통해서 접근 할수 있는 저장소는 iolist 이다.
*/
CREATE USER iolist IDENTIFIED BY 12341234
DEFAULT TABLESPACE iolist;

/*
생성한 iolist 사용자가 DB에 접속하고,
TABLE을 생성하고, CRUD 를 실행하는 부분 
각각 별도의 권한 정책에 의하여 허가를 해 주어야 한다.
학습 목적상 세세한 권한 정책을 부여하기가 불편하여 

Oralce의 SYSDBA 권한보다 한단계 낮은 DBA 권한을 부여한다.

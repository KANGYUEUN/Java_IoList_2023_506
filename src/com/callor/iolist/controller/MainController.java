...
public class MainController {
	...
	protected void nav() {
		String[] navs = { "상품관리", Line.sLine(100), "\t\t1. 상품 리스트", "\t\t2. 상품등록 및 수정", Line.sLine(100), "고객관리",
				Line.sLine(100), "\t\t3. 고객리스트", "\t\t4. 고객등록 및 수정", Line.sLine(100), "상품판매", Line.sLine(100),
				"\t\t5. 장바구니 담기", "\t\t6. 전체 리스트", "\t\t7. 기간별 리스트", "\t\t8. 구매자별 리스트 ", "\t\t9. 상품별 리스트",
				Line.sLine(100), "OUIT. 끝내기", Line.dLine(100), };
